...
import { Home, Folder, Star, Layers, Trash2, Settings, ChevronLeft, ChevronRight, User } from 'lucide-react';
import QuickformImage from '@/components/Datatable/image.png'
import QuickformLogo from '@/pages/logofinal.png'
const navOptions = [
        ...
        >
          <div>
            ...
            <div className="flex items-center px-6 py-6 border-b border-gray-100">
              <img src={QuickformLogo} alt="Quick Form" className="h-10 w-12" />
              <span className="">
              <img src={QuickformImage} alt="Quick Form"  />
              </span>
            </div>
            {/* Nav */}
