    ...
    switch (fieldType) {
          ...
          <div className="mb-4">
            ...
            <div className="relative w-1/2">
              ...
              <label
                ...
                className={`block h-32 text-sm p-2 border rounded bg-gray-100 flex items-center justify-center text-gray-700 hover:bg-gray-200 cursor-pointer ${isDisabled ? "cursor-not-allowed opacity-50" : ""
          ...
          <div className="mb-4">
            <div className="flex items-center">
              ...
              <label className="inline-flex items-center cursor-pointer ml-3">
                ...
                />
                <div
                  className={`w-11 h-6 bg-gray-200 rounded-full peer ${toggles[fieldId] ? "peer-checked:bg-blue-600" : ""
                    }`}
                >
                  <div
                    className={`w-5 h-5 bg-white rounded-full shadow-md transform transition-transform ${toggles[fieldId] ? "translate-x-5" : "translate-x-1"
                      }`}
                  />
                </div>
              </label>
      ...
      case "header":
        ...
        return (
          <div className="mb-6">
            <h2
              className={`text-2xl font-bold text-gray-800 ${properties.alignment === "left"
                  ? "text-left"
                ...
                {ratingOptions[properties.ratingType || "emoji"].map(
                  (option, idx) => (
                    <button
                      ...
                      disabled={isDisabled}
                      className={`text-2xl ${selectedRatings[fieldId] === option.value
                          ? "text-blue-600"
                          : "text-gray-400"
