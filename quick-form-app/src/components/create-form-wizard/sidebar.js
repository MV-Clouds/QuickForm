...
const Sidebar = ({ username , selected = 'home', open, setOpen, onSelect }) => {
  const navOptions = [
    { label: 'Home', icon: selected === 'home'? ( <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8.07002 0.819849L1.14002 6.36985C0.360021 6.98985 -0.139979 8.29985 0.0300209 9.27985L1.36002 17.2398C1.60002 18.6598 2.96002 19.8098 4.40002 19.8098H15.6C17.03 19.8098 18.4 18.6498 18.64 17.2398L19.97 9.27985C20.13 8.29985 19.63 6.98985 18.86 6.36985L11.93 0.829849C10.86 -0.0301508 9.13002 -0.0301508 8.07002 0.819849Z" fill="url(#paint0_linear_0_1)" fill-opacity="0.8"/>
      <path d="M10 16V13" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <defs>
      <linearGradient id="paint0_linear_0_1" x1="19.9998" y1="9.99672" x2="-0.00317383" y2="9.99672" gradientUnits="userSpaceOnUse">
      ...
      <path d="M10.07 2.81985L3.14002 8.36985C2.36002 8.98985 1.86002 10.2998 2.03002 11.2798L3.36002 19.2398C3.60002 20.6598 4.96002 21.8098 6.40002 21.8098H17.6C19.03 21.8098 20.4 20.6498 20.64 19.2398L21.97 11.2798C22.13 10.2998 21.63 8.98985 20.86 8.36985L13.93 2.82985C12.86 1.96985 11.13 1.96985 10.07 2.81985Z" stroke="#0B0A0A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M12 18V15" stroke="#0B0A0A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
      , key: 'home' },
    { label: 'Folders', icon: selected === 'folders' ?  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M18.2222 7.55534H11.6978C11.265 7.55515 10.8472 7.39713 10.5227 7.11089L8.50311 5.33312M18.2222 7.55534C18.6937 7.55534 19.1459 7.74264 19.4793 8.07604C19.8127 8.40944 20 8.86162 20 9.33312V17.3331C20 17.8046 19.8127 18.2568 19.4793 18.5902C19.1459 18.9236 18.6937 19.1109 18.2222 19.1109H5.77778C5.30628 19.1109 4.8541 18.9236 4.5207 18.5902C4.1873 18.2568 4 17.8046 4 17.3331V6.66645C4 6.19495 4.1873 5.74277 4.5207 5.40937C4.8541 5.07597 5.30628 4.88867 5.77778 4.88867H7.32889C7.76163 4.88886 8.17944 5.04688 8.504 5.33312M18.2222 7.55534C18.2222 6.96597 17.9881 6.40074 17.5713 5.98399C17.1546 5.56724 16.5894 5.33312 16 5.33312H8.50311" fill="url(#paint0_linear_1523_5190)" fill-opacity="0.8"/>
      <path d="M18.2222 7.55534H11.6978C11.265 7.55515 10.8472 7.39713 10.5227 7.11089L8.50311 5.33312H16C16.5894 5.33312 17.1546 5.56724 17.5713 5.98399C17.9881 6.40074 18.2222 6.96597 18.2222 7.55534ZM18.2222 7.55534C18.6937 7.55534 19.1459 7.74264 19.4793 8.07604C19.8127 8.40944 20 8.86162 20 9.33312V17.3331C20 17.8046 19.8127 18.2568 19.4793 18.5902C19.1459 18.9236 18.6937 19.1109 18.2222 19.1109H5.77778C5.30628 19.1109 4.8541 18.9236 4.5207 18.5902C4.1873 18.2568 4 17.8046 4 17.3331V6.66645C4 6.19495 4.1873 5.74277 4.5207 5.40937C4.8541 5.07597 5.30628 4.88867 5.77778 4.88867H7.32889C7.76163 4.88886 8.17944 5.04688 8.504 5.33312" stroke="#EDF8FF" stroke-linecap="round" stroke-linejoin="round"/>
      <defs>
      <linearGradient id="paint0_linear_1523_5190" x1="20" y1="11.9998" x2="4" y2="11.9998" gradientUnits="userSpaceOnUse">
      <stop offset="0.0480769" stop-color="#0B295E"/>
      <stop offset="1" stop-color="#1D6D9E"/>
      </linearGradient>
      </defs>
    ...
    { label: 'Favourite', icon: selected === 'favourite' ?  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <stop offset="1" stop-color="#1D6D9E"/>
       ...
       : <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.72238 6.72642C10.736 4.90881 11.2424 4 12 4C12.7576 4 13.264 4.90881 14.2776 6.72642L14.54 7.19682C14.828 7.71362 14.972 7.97203 15.196 8.14243C15.42 8.31283 15.7 8.37603 16.26 8.50243L16.7688 8.61763C18.7368 9.06323 19.72 9.28563 19.9544 10.0384C20.188 10.7904 19.5176 11.5752 18.176 13.1441L17.8288 13.5497C17.448 13.9953 17.2568 14.2185 17.1712 14.4937C17.0856 14.7697 17.1144 15.0673 17.172 15.6617L17.2248 16.2033C17.4272 18.2969 17.5288 19.3433 16.916 19.8081C16.3032 20.2729 15.3816 19.8489 13.54 19.0009L13.0624 18.7817C12.5392 18.5401 12.2776 18.4201 12 18.4201C11.7224 18.4201 11.4608 18.5401 10.9376 18.7817L10.4608 19.0009C8.61837 19.8489 7.69677 20.2729 7.08476 19.8089C6.47116 19.3433 6.57276 18.2969 6.77516 16.2033L6.82796 15.6625C6.88556 15.0673 6.91436 14.7697 6.82796 14.4945C6.74316 14.2185 6.55196 13.9953 6.17116 13.5505L5.82396 13.1441C4.48235 11.576 3.81194 10.7912 4.04554 10.0384C4.27915 9.28563 5.26395 9.06243 7.23196 8.61763L7.74077 8.50243C8.29997 8.37603 8.57917 8.31283 8.80397 8.14243C9.02878 7.97203 9.17198 7.71362 9.45998 7.19682L9.72238 6.72642Z" stroke="#0B0A0A" stroke-width="1.5"/>
    </svg>
    
      , key: 'favourite' },
    { label: 'Fieldset', icon: <Layers size={20} />, key: 'fieldset' },
    { label: 'Integrations', icon: <Settings2 size={20} />, key: 'integration' },
    { label: 'Bin', icon:selected === 'bin' ? <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3.17378 4.9566C3.00885 4.9566 2.88347 5.10481 2.9108 5.26746L4.85856 16.8574H12.8586L14.8063 5.26746C14.8337 5.10481 14.7083 4.9566 14.5433 4.9566H3.17378ZM15.2586 2.17974C15.4058 2.17974 15.5252 2.29913 15.5252 2.4464V3.23538C15.5252 3.38266 15.4058 3.50205 15.2586 3.50205H2.45856C2.31129 3.50205 2.19189 3.38266 2.19189 3.23538V2.4464C2.19189 2.29913 2.31129 2.17974 2.45856 2.17974H5.99923C6.59923 2.17974 7.08656 1.45312 7.08656 0.857422H10.6306C10.6306 1.45312 11.1172 2.17974 11.7179 2.17974H15.2586Z" fill="url(#paint0_linear_1523_12958)" fill-opacity="0.8"/>
      <defs>
      <linearGradient id="paint0_linear_1523_12958" x1="15.5252" y1="8.85742" x2="2.19189" y2="8.85742" gradientUnits="userSpaceOnUse">
      <stop offset="0.0480769" stop-color="#0B295E"/>
      <stop offset="1" stop-color="#1D6D9E"/>
      </linearGradient>
      </defs>
                ...
                >
                  {selected === opt.key && (
                    <div
                      ...
                      style={{
                        background: 'linear-gradient(180deg, #0B295E 0%, #1D6D9E 100%)',
        ...
        >
          <div className="flex flex-col items-center pt-4 gap-2">
            ...
            <motion.div
              ...
              className="mb-4"
            >
              <img src={'/quickform-logo.png'} alt="Quick Form" className="h-10 w-10 rounded-lg shadow-sm" />
            </motion.div>
            {/* Nav Icons */}
            <nav className="flex flex-col gap-2 items-center w-full">
              {navOptions.map(opt => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`relative flex items-center justify-center w-12 h-12 rounded-xl transition-colors duration-200 group ${selected === opt.key ? 'bg-blue-50 shadow border border-indigo-200' : 'hover:bg-gray-100'}`}
                  onClick={() => onSelect && onSelect(opt.key)}
                  style={{ outline: selected === opt.key ? '2px solid #1D6D9E' : 'none' }}
                >
