    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          ...
          >
            ...
            <Select
              ...
              prefix={
                ...
                >
                  <path
                    d="M5.07153 7H21.0715M7.7382 12H18.4049M10.9382 17H15.2049"
                    stroke="#0B0A0A"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
        ...
        <div className="flex items-center gap-4">
          <div className="flex rounded-lg border border-gray-300 p-1 bg-gray-50 shadow-sm">
            <button
              ...
              style={{
                background: `${
                  viewMode === "table"
                    ? "linear-gradient(to right, #0B295E, #1D6D9E)"
                    : ""
                }`,
              }}
            >
            ...
            <button
              className={`p-2 ${
                viewMode === "card" ? "text-white" : "text-gray-700"
              }  rounded-lg transition-colors`}
          ...
          <button
            className="flex items-center gap-2 rounded-lg px-4 py-2 text-white hover:shadow-md"
            style={{
              background: "linear-gradient(to right, #0B295E, #1D6D9E)",
            }}
            ...
            {paginatedData.map((item, index) => (
              ...
              >
                <div className="flex flex-col sm:flex-row h-full">
                  ...
                  <div
                    className="w-full sm:w-1/2 bg-gradient-to-br from-blue-50 to-indigo-50 p-5 flex items-center justify-center"
                                    ...
                                    switch (
                                      ...
                                      case "shorttext":
                                        return (
                                          <input
                                            type="text"
                                            className="w-full rounded border border-gray-200 px-2 py-1 text-sm bg-white focus:border-indigo-400 focus:outline-none"
                                      ...
                                      case "textarea":
                                        return (
                                          <textarea
                                            className="w-full rounded border border-gray-200 px-2 py-1 text-sm bg-white focus:border-indigo-400 focus:outline-none resize-none"
                                            rows={2}
                                            placeholder={"Enter " + field.Name}
                                            disabled
                                          />
                    ...
                    <div>
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          ...
                          <p className="text-md text-black-500 mt-6 font-bold">
                        ...
                        >
                          <div className="relative">
                            ...
                            />
                            <div
                              className={`block text-white w-20 h-6 rounded-full ${
                                item.status === "Active"
                                  ? "bg-green-500 px-3 py-0.5"
                                  : "px-6 py-0.5 bg-gray-300"
                              }`}
                            >
                  ...
                  table.getRowModel().rows.map((row, i) => (
                    ...
                    >
                      {row.getVisibleCells().map((cell, cellIndex) => (
                        <div
                          key={cell.id}
                          className={`flex-1 px-6 py-3 flex justify-center items-center text-sm ${
                            cellIndex === 0
            ...
            if (start > 2) {
              pageNumbers.push(
                <motion.button
                  ...
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.95 }}
                  className={`mx-1 rounded-lg px-3 py-1 font-medium ${
                    pageIndex + 1 === 1
                      ? "bg-[#028AB0] text-white"
                      : "hover:bg-blue-50"
                  }`}
                  style={
                    pageIndex + 1 === 1
                      ? { background: "#EDF8FF", color: "#028AB0" }
                      : { color: "#5F6165" }
                  }
              ...
              for (let i = end + 1; i <= totalPages; i++) {
                pageNumbers.push(
                  <motion.button
                    ...
                    style={
                      pageIndex + 1 === i
                        ? { background: "#028AB0", color: "#028AB0" }
                        : { color: "#5F6165" }
                    }
                    onClick={() => setPageIndex(i - 1)}
                  >
