...
const Login = () => {
  ...
  const allFeatures = [
    {
      ...
      desc: "Create and deploy forms in minutes, not hours.",
      icon: "flash_icon.svg",
    },
    {
      title: "Deep Integration",
      desc: "Native Salesforce connectivity for real-time data sync.",
      icon: "deep_integration_icon.svg",
    },
    {
      title: "Customizable",
      desc: "Tailor forms to your exact needs with powerful design tools.",
      icon: "customizable_icon.svg",
    },
    {
      title: "Secure & Reliable",
      desc: "Enterprise-grade security to protect your valuable data.",
      icon: "secure_icon.svg",
    },
    {
      title: "No-Code Forms",
      desc: "No coding required! Simply click, drag-drop: turning complexity into simplicity effortlessly!",
      icon: "flash_icon.svg",
    },
    {
      title: "Boost Productivity",
      desc: "Auto-magically fill your Salesforce objects with every form submission.",
      icon: "deep_integration_icon.svg",
    },
    {
      title: "Limitless Design Possibilities",
      desc: "Make your forms an extension of your brand with just a few clicks.",
      icon: "customizable_icon.svg",
    },
    {
      title: "Submission Alerts",
      desc: "Get instant email alerts and optional PDF attachments when your forms are filled out.",
      icon: "secure_icon.svg",
    },
    {
      title: "Hassle-free Publish",
      desc: "An uncomplicated process with several options to publish forms.",
      icon: "flash_icon.svg",
    },
  ];
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem("userId", "005gK0000068QxxQAE"); // Clear userId
    ...
    const handleMessage = (event) => {
      ...
      if (
        event.origin ===
        "https://vm6pandneg.execute-api.us-east-1.amazonaws.com"
      ) {
  ...
  const openPopup = () => {
    ...
    if (
      org === "Pick an option" ||
      (org === "custom" && !validateCustomUrl(customUrl))
    )
      return; // Do nothing if org not selected
      ...
      >
        <div className="content-container flex w-full">
          <div className="left-container">
            <div className="features-section">
              <p className="main-title">
                ...
                <br />
                with <span className="quickform-text">QuickForm</span>
              </p>
              <div className="subtitle-div">
                <p className="subtitle">
                  Seamlessly integrate with Salesforce and manage your data with
                  unparalleled efficiency. Focus on what matters most.
                </p>
              </div>
          ...
          <div className="right-container">
            <div className="quickform-logo">
              <img
                src="/images/quickform-logo.png"
                alt="QuickForm Logo"
                className="logo"
              />
            </div>
              ...
              <div className="login-form">
                ...
                <button
                  ...
                  className={`login-button ${
                    isButtonDisabled || isLoginProgress ? "disabled" : ""
                  }`}
                >
                  <svg
                    className="gate-logo"
                  ...
                  >
                    <path
                      d="M1.60059 9.16661H13.3612M13.3612 9.16661L10.421 6.64648M13.3612 9.16661L10.421 11.6867"
                      stroke="white"
                      stroke-width="1.5"
