...
export default function ThankYouPageEditor({
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-auto relative p-4">
        ...
        <div 
          ...
          style={{
            ...
            height: 0,
            paddingTop: `${(canvasSize.height / canvasSize.width) * 100}%`, // Aspect ratio padding
          }}
        >
          {/* Canvas with dynamic scaling */}
          <div
            className="absolute top-0 left-0 w-full h-full border border-gray-200 bg-white rounded-lg shadow-lg"
            style={{
              backgroundColor: theme.backgroundColor,
      ...
      {/* Right Sidebar - unchanged from original */}
