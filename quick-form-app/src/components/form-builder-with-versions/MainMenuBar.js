        ...
        <nav className="flex-1 px-4 py-6">
          <ul className="space-y-2">
            ...
            <li>
              <a
                href="/form-builder"
                className={`flex items-center px-3 py-3 text-sm font-medium transition-colors relative ${
            ...
            <li>
              <button
                ...
                onClick={() =>
                  selectedVersionId &&
                  navigate(`/submissions/${selectedVersionId}`)
                }
              >
            ...
            <li>
              <button
                ...
                onClick={() =>
                  selectedVersionId &&
                  navigate(`/notifications/${selectedVersionId}`)
                }
              >
                <span className="mr-3">
                  <svg
            ...
            <li>
              ...
              >
                <span className="mr-3">
                  ...
                  >
                    <path
                      d="M5.57122 13.286C6.02588 13.286 6.46192 13.1054 6.78341 12.7839C7.1049 12.4624 7.28551 12.0264 7.28551 11.5717C7.28551 11.1171 7.1049 10.681 6.78341 10.3595C6.46192 10.038 6.02588 9.85742 5.57122 9.85742C5.11657 9.85742 4.68053 10.038 4.35904 10.3595C4.03755 10.681 3.85693 11.1171 3.85693 11.5717C3.85693 12.0264 4.03755 12.4624 4.35904 12.7839C4.68053 13.1054 5.11657 13.286 5.57122 13.286Z"
                      fill="#0B0A0A"
                      stroke="#0B0A0A"
                      strokeWidth="1.71429"
                      strokeLinejoin="round"
            ...
            <li>
              <button
                ...
                onClick={() =>
                  selectedVersionId &&
                  navigate(`/conditions/${selectedVersionId}`)
                }
              >
                <span className="mr-3">
                  <svg
                  ...
                  >
                    ...
                    />
                    <path
                      d="M17.3334 9.33333C18.8062 9.33333 20.0001 8.13943 20.0001 6.66667C20.0001 5.19391 18.8062 4 17.3334 4C15.8607 4 14.6667 5.19391 14.6667 6.66667C14.6667 8.13943 15.8607 9.33333 17.3334 9.33333Z"
                      stroke="#0B0A0A"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M6.66667 19.9993C8.13943 19.9993 9.33333 18.8054 9.33333 17.3327C9.33333 15.8599 8.13943 14.666 6.66667 14.666C5.19391 14.666 4 15.8599 4 17.3327C4 18.8054 5.19391 19.9993 6.66667 19.9993Z"
                      stroke="#0B0A0A"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M17.3333 9.33398C17.3333 11.4557 16.4904 13.4905 14.9901 14.9908C13.4898 16.4911 11.455 17.334 9.33325 17.334"
                      stroke="#0B0A0A"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              >
                <span className="mr-3">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9c1.58 0 3.04.41 4.32 1.13"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <li>
              ...
              >
                <span className="mr-3">
                  ...
                  >
                    <path
                      d="M5.90909 15.3631C7.51574 15.3631 8.81818 14.0607 8.81818 12.454C8.81818 10.8474 7.51574 9.54492 5.90909 9.54492C4.30244 9.54492 3 10.8474 3 12.454C3 14.0607 4.30244 15.3631 5.90909 15.3631Z"
                      stroke="#0B0A0A"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M16.091 21.91C17.6976 21.91 19.0001 20.6075 19.0001 19.0009C19.0001 17.3942 17.6976 16.0918 16.091 16.0918C14.4843 16.0918 13.1819 17.3942 13.1819 19.0009C13.1819 20.6075 14.4843 21.91 16.091 21.91Z"
                      stroke="#0B0A0A"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M16.091 8.81818C17.6976 8.81818 19.0001 7.51574 19.0001 5.90909C19.0001 4.30244 17.6976 3 16.091 3C14.4843 3 13.1819 4.30244 13.1819 5.90909C13.1819 7.51574 14.4843 8.81818 16.091 8.81818Z"
                      stroke="#0B0A0A"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M13.6452 7.48242L8.35425 10.8824"
                      stroke="#0B0A0A"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M8.35425 14.0273L13.6452 17.4273"
                      stroke="#0B0A0A"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
