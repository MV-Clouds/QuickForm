  ...
  const navItems = [
    {
      ...
      onClick: () =>
        selectedVersionId && navigate(`/form-builder/${selectedVersionId}`),
      icon: (
        <svg
          width="24"
          height="24"
    ...
    },
    {
      ...
      onClick: () =>
        selectedVersionId && navigate(`/notifications/${selectedVersionId}`),
      icon: (
        <svg
          width="24"
          height="24"
    ...
    },
    {
      ...
      onClick: () =>
        selectedVersionId && navigate(`/conditions/${selectedVersionId}`),
      icon: (
        <svg
          width="24"
          height="24"
      ...
      icon: (
        ...
        >
          ...
          <path
            d="M5.909 15.363a2.909 2.909 0 1 0 0-5.818 2.909 2.909 0 0 0 0 5.818z"
            stroke={
              window.location.pathname.includes("/share") ? "white" : "#0B0A0A"
            }
            strokeWidth="1.5"
            fill="none"
          />
      ...
      <div className="relative h-full flex flex-col overflow-y-auto overflow-x-hidden">
        <div
          className={`flex border-b border-gray-100 ${
            isSidebarOpen ? "px-8 py-4" : "px-1 py-5"
          }`}
        >
          <img
            src={
              isSidebarOpen
                ? "/images/quickform-logo.png"
        ...
        <nav className="flex-1 py-6">
          <ul className="space-y-2">
            {navItems.map((item) => (
              <li key={item.name}>
                <motion.button
                  className={`flex items-center py-1/2 pl-5 w-full text-sm font-medium transition-colors relative rounded-md ${
                    isSidebarOpen ? "px-3" : "px-[0.4rem]"
                  }`}
                ...
                >
                  {window.location.pathname.includes(item.path) && (
                    <motion.div
                      ...
                      style={{
                        background:
                          "linear-gradient(to right, rgba(11, 41, 94, 1), rgba(37, 127, 184, 1))",
                        width: "6px",
                        height: "100%",
                      }}
                  ...
                  <motion.span
                    className={`flex justify-start p-2 items-center w-full rounded gap-3 ${
                      window.location.pathname.includes(item.path)
                        ? "bg-gray-100"
                        : ""
                    }`}
