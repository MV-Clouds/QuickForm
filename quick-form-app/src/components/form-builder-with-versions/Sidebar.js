      ...
      return (
        <svg {...iconProps} viewBox="0 0 24 24">
          <path
            ...
            d="M7.5 8.25h9M7.5 15.75h9M7.5 12h9"
          />
        </svg>
      );
    case "shorttext":
      ...
      return (
        <svg {...iconProps} viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25M9 16.5v.75m3-3v3M15 12v5.25m0 0V21m0-3.75h3.75M21 14.25v3.75m0 0V21m0-3.75h-3.75"
          />
        </svg>
      );
          ...
          <div className="p-4">
            <div className="space-y-4">
              {themes.map((theme) => (
                <div
                  key={theme.name}
                  className={`rounded-lg shadow border p-3 flex items-center gap-4 cursor-pointer hover:scale-105 hover:shadow-lg transition-transform duration-200 ${
                    theme.preview
                  } ${
                    selectedTheme?.name === theme.name
                      ? "ring-4 ring-blue-400 border-blue-600"
                      : "border-gray-200"
                  }`}
                  onClick={() => onThemeSelect(theme)}
                  style={{
                    opacity: selectedTheme?.name === theme.name ? 1 : 0.85,
                  }}
                >
                  <div
                    className={`w-8 h-8 rounded-full ${theme.color} border-2 border-white shadow`}
                  />
                  <div>
