...
function FormBuilder({
  ...
  const handleFieldClick = (fieldId, sectionSide = null) => {
    ...
    const isSectionField = fields.find(
      (field) => field.id === fieldId && field.type === "section"
    );
        ...
        <div className="page-nav flex items-center gap-2">
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M18.2505 11.25L13.8605 15.74C13.8254 15.7736 13.7975 15.814 13.7784 15.8586C13.7593 15.9033 13.7495 15.9514 13.7495 16C13.7495 16.0486 13.7593 16.0967 13.7784 16.1414C13.7975 16.186 13.8254 16.2264 13.8605 16.26L18.2505 20.75"
                stroke="#000000"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
              ...
              return (
                <button
                  ...
                  className={`page-button ${
                    currentPageIndex === actualIndex ? "active" : ""
                  }`}
                  title={page.name}
                >
                  Page {actualIndex + 1}
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M13.7495 11.25L18.1395 15.74C18.1746 15.7736 18.2025 15.814 18.2216 15.8586C18.2407 15.9033 18.2505 15.9514 18.2505 16C18.2505 16.0486 18.2407 16.0967 18.2216 16.1414C18.2025 16.186 18.1746 16.2264 18.1395 16.26L13.7495 20.75"
                stroke="#000000"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`rounded-md ${
              !canUndo ? "text-gray-400" : "text-gray-700 hover:bg-gray-100"
            }`}
            title="Undo"
          >
            <svg
            ...
            >
              ...
              />
              <path
                d="M15 23H18.75C20.1424 23 21.4777 22.4469 22.4623 21.4623C23.4469 20.4777 24 19.1424 24 17.75C24 16.3576 23.4469 15.0223 22.4623 14.0377C21.4777 13.0531 20.1424 12.5 18.75 12.5H9M11.5 9L8 12.5L11.5 16"
                stroke="#000000"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
          ...
          <button
            ...
            disabled={!canRedo}
            className={`rounded-md ${
              !canRedo ? "text-gray-400" : "text-gray-700 hover:bg-gray-100"
            }`}
            title="Redo"
          >
            <svg
            ...
            >
              <rect
                ...
                height="30.6667"
                rx="3.33333"
                transform="matrix(-1 0 0 1 30.6667 0)"
                stroke="#F2F4F7"
                strokeWidth="1.33333"
              />
              <path
                d="M17 23H13.25C11.8576 23 10.5223 22.4469 9.53769 21.4623C8.55312 20.4777 8 19.1424 8 17.75C8 16.3576 8.55312 15.0223 9.53769 14.0377C10.5223 13.0531 11.8576 12.5 13.25 12.5H23M20.5 9L24 12.5L20.5 16"
                stroke="#000000"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
                        ...
                        >
                          <FormField
                            ...
                            isSelected={
                              ...
                              selectedSectionSide === field.sectionSide
                            }
                            ...
                            clipboard={clipboard}
                            handlePaste={() =>
                              handlePaste(pageIndex, index + 1, null, null)
                            }
              ...
              <footer className="flex justify-center gap-4 items-center p-4">
                {pageIndex > 0 && (
                  <button
                    ...
                    className={`px-6 py-2 rounded-lg ${
                      selectedTheme?.buttonBg || "bg-gray-600"
                    } ${
                      selectedTheme?.buttonText || "text-white"
                    } hover:opacity-90`}
                ...
                {pageIndex < pages.length - 1 && (
                  <button
                    type="button"
                    className={`px-6 py-2 rounded-lg ${
                      selectedTheme?.buttonBg || "bg-blue-600"
                    } ${
                      selectedTheme?.buttonText || "text-white"
                    } hover:opacity-90`}
