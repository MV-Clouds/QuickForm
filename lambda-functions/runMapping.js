...
//   // FIX: Filter out the content document configuration object
//   const actualFieldMappings = fieldMappings.filter(mapping => 
...
//       const [baseFieldId, subfield] = formFieldId.split('_');
//       if (baseFieldId in formData) {
//         value = formData[mapping.formFieldId] || '';
//       }
//     } else {
...
//   console.log(`Loop Collection for ${nodeId}:`, JSON.stringify(previousResults[config.loopCollection], null, 2));
...
//   console.log('nodes in run flow:: ', nodes);
...
//         config: node.Config__c ? JSON.parse(node.Config__c) : node.config,
//         // config: node.Config__c || {}
//       };
//     });
