...
export const handler = async (event) => {
  ...
  async function logNodeEventDirect(logData) {
    try {
      ...
      const recordId = logData.submissionId || logData.tempSubmissionId || uuidv4();
      ...
      await dynamoClient.send(new PutItemCommand({
        ...
        Item: {
          ...
          RecordId: { S: recordId },
          RecordType: { S: 'Submission Log' }, // Always 'Submission Log'
          Type: { S: logData.type || 'Mapping' }, // Always 'Mapping'
          SubType: { S: subType },
          ...
          RetryStatus: { S: 'N/A' },
          RetryAttempts: { N: '0' },
          // Store execution details in Data field
