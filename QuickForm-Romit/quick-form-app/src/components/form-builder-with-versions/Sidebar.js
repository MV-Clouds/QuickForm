...
function Sidebar({ selectedTheme, onThemeSelect, themes, showThemeTab = true, showFieldSetTab = true, showPaymentTab = true }) {
  ...
  return (
    <div className="custom-builder-card">
      ...
      <div className="p-4 pb-2">
        <h1 className="text-lg font-semibold text-gray-900">{showThemeTab ? 'Builder' : 'Fieldset Builder'} </h1>
      </div>
      {showThemeTab && (
        // {/* Main Tabs */}
      ...
      {activeMainTab === 'Form' && (
        <div className="flex border-b border-gray-200 px-4">
          <button
            className={`flex-1 py-3 text-sm text-center font-medium transition-colors ${activeSubTab === 'Fields'
          ...
          {showFieldSetTab && (<button
            className={`flex-1 py-3 text-sm text-center font-medium transition-colors ${activeSubTab === 'Fieldsets'
              ? 'text-gray-900 border-b-2 border-blue-600'
              : 'text-gray-600 hover:bg-gray-50'
              }`}
          ...
          {showPaymentTab && (<button
            className={`flex-1 py-3 text-sm text-center font-medium transition-colors ${activeSubTab === 'Payments'
              ? 'text-gray-900 border-b-2 border-blue-600'
              : 'text-gray-600 hover:bg-gray-50'
              }`}
